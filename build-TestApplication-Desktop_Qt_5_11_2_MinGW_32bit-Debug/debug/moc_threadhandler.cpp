...
#include "../../TestApplication/threadhandler.h"
...
QT_MOC_LITERAL(3, 24, 8), // "rounding"
QT_MOC_LITERAL(4, 33, 7), // "process"
QT_MOC_LITERAL(5, 41, 8), // "getValue"
QT_MOC_LITERAL(6, 50, 10), // "getCounter"
QT_MOC_LITERAL(7, 61, 10) // "stopThread"

    },
    "ThreadHandler\0finished\0\0rounding\0"
    "process\0getValue\0getCounter\0stopThread"
};
...
void ThreadHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->rounding(); break;
        case 2: _t->process(); break;
        case 3: { long long _r = _t->getValue();
            if (_a[0]) *reinterpret_cast< long long*>(_a[0]) = std::move(_r); }  break;
        case 4: { int _r = _t->getCounter();
        ...
        {
            using _t = void (ThreadHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadHandler::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ThreadHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadHandler::rounding)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ThreadHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ThreadHandler.data,
      qt_meta_data_ThreadHandler,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void ThreadHandler::finished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ThreadHandler::rounding()
{
